...
python3 demo/inference.py --base_model Qwen/Qwen3.5-4B --lora_model outputs-sft-qwen35-4b-v1 --interactive
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument("--no_repeat_ngram_size", type=int, default=3, help="N-gram repetition blocking size")
